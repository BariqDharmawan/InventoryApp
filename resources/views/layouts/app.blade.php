    ...
    <aside
        ...
        <div class="items-center block w-auto h-screen overflow-auto grow basis-full">
            <ul class="flex flex-col pl-0 mb-0">
                <x-li-nav-item :active="true" href="{{ route('dashboard') }}" label="Dashboard">
                    <x-slot name="icon">
                ...
                <x-li-nav-item href="../template/build/pages/tables.html" label="Tables">
                    <x-slot name="icon">
                ...
                <x-li-nav-item href="../template/build/pages/billing.html" label="Billing">
                    <x-slot name="icon">
                ...
                <x-li-nav-item href="../template/build/pages/virtual-reality.html" label="Virtual Reality">
                    <x-slot name="icon">
                        <svg height="12px" version="1.1" viewBox="0 0 42 42" width="12px"
                            xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
                ...
                <x-li-nav-item href="../template/build/pages/rtl.html" label="RTL">
                    <x-slot name="icon">
                ...
                <x-li-nav-item href="../template/build/pages/profile.html" label="Profile">
                    <x-slot name="icon">
                        ...
                        <title>settings</title>
                        <g fill-rule="evenodd" fill="none" stroke-width="1" stroke="none">
                            <g fill-rule="nonzero" fill="#FFFFFF" transform="translate(-2020.000000, -442.000000)">
                                <g transform="translate(1716.000000, 291.000000)">
                                    <g transform="translate(304.000000, 151.000000)">
                                        <polygon class="fill-slate-800 opacity-60"
                                            points="18.0883333 15.7316667 11.1783333 8.82166667 13.3333333 6.66666667 6.66666667 0 0 6.66666667 6.66666667 13.3333333 8.82166667 11.1783333 15.315 17.6716667">
                ...
                <x-li-nav-item href="../template/build/pages/sign-in.html" label="Sign In">
                    <x-slot name="icon">
                        <svg height="12px" version="1.1" viewBox="0 0 40 44" width="12px"
                            xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
                ...
                <x-li-nav-item href="../template/build/pages/sign-up.html" label="Sign Up">
                    <x-slot name="icon">
                        <svg height="20px" version="1.1" viewBox="0 0 40 40" width="12px"
                            xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
