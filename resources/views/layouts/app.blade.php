...
<html>
  <head>
    ...
    <link href="{{ asset('template/build/assets/css/soft-ui-dashboard-tailwind.min.css?v=1.0.5') }}" rel="stylesheet" />
  </head>
    ...
    <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
      ...
      <div class="items-center block w-auto h-screen overflow-auto grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            <x-li-nav-item label="Dashboard" href="{{ route('dashboard') }}" :active="true">
                <x-slot name="icon">
            ...
            <x-li-nav-item label="Virtual Reality" href="../template/build/pages/virtual-reality.html">
                <x-slot name="icon">
                    <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <x-li-nav-item label="RTL" href="../template/build/pages/rtl.html">
                <x-slot name="icon">
            ...
            <x-li-nav-item label="Profile" href="../template/build/pages/profile.html">
                <x-slot name="icon">
            ...
            <x-li-nav-item label="Sign In" href="../template/build/pages/sign-in.html">
                <x-slot name="icon">
            ...
            <x-li-nav-item label="Sign Up" href="../template/build/pages/sign-up.html">
                <x-slot name="icon">
            ...
            <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
                ...
                <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                    <li class="flex items-center">
                        <a href="../template/build/pages/sign-in.html" class="block px-0 py-2 font-semibold transition-all ease-nav-brand text-sm text-slate-500">
                    ...
                    <li class="relative flex items-center pr-2">
                        ...
                        <!-- add show class on dropdown open js -->
                            ...
                            <li class="relative mb-2">
                                ...
                                <div class="flex py-1">
                                    <div class="my-auto">
                                        <img src="{{ asset('img/team-2.jpg') }}" class="inline-flex items-center justify-center mr-4
