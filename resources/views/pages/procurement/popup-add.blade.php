    ...
    <div class="relative max-h-full w-full max-w-2xl">
        <form action="{{ route('procurement.store') }}" class="relative rounded-lg bg-white shadow" method="POST">
            ...
            <div class="p-6">
                ...
                <article class="mb-3 rounded-lg border border-gray-200 p-3">
                    ...
                    <template id="fill-qty-selected-product">
                        <div class="mb-6">
                            <label class="label-qty-selected-product mb-2 block text-sm font-medium text-gray-900"
                                for="qty-selected-product-column">
                                QTY
                            </label>
                            <input
                                class="input-qty-selected-product block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 shadow-sm focus:border-blue-600 focus:ring-blue-600"
